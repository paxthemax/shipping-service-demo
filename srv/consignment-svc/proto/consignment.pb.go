...
func (*Consignment) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_3bfcc1c53c0ef53e, []int{0}
}
...
func (*Container) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_3bfcc1c53c0ef53e, []int{1}
}
...
func (*GetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_3bfcc1c53c0ef53e, []int{2}
}
...
func (*CreateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_3bfcc1c53c0ef53e, []int{3}
}
...
func (*GetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_3bfcc1c53c0ef53e, []int{4}
}
...
func init() {
	proto.RegisterFile("proto/consignment.proto", fileDescriptor_consignment_3bfcc1c53c0ef53e)
}

var fileDescriptor_consignment_3bfcc1c53c0ef53e = []byte{
	// 364 bytes of a gzipped FileDescriptorProto
	,
}
